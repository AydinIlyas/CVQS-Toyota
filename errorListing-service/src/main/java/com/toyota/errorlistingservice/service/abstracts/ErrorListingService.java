...
public interface ErrorListingService {
    Mono<PaginationResponse<Object>> getVehicles(HttpServletRequest request, int page, int size, List<String> sort,
                                                 String sortOrder, String model, String vin, String yearOfProduction,
                                                 String transmissionType, String engineType, String color);

    Mono<PaginationResponse<Object>> getDefects(HttpServletRequest request,int page,int size,String type, String state, String reportTime, String reportedBy,
